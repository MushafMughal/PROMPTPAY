...
class BankAccountSerializer(serializers.ModelSerializer):
    ...
    username = serializers.CharField(source="user.username", read_only=True)  # Get username
    ...
    class Meta:
        model = BankAccount
        fields = ['name', 'username', 'email', 'phone_number','bank_name', 'account_number', 'balance', 'IBAN']
